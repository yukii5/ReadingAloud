                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="auth_name col-md-4 col-form-label text-md-right">{{ __('Name') }}</label>
                        ...
                        <div class="form-group row">
                            <label for=" password-confirm" class="auth_name col-md-4 col-form-label text-md-right">{{ __('Confirm Password') }}</label>
